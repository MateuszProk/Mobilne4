...
public class TaskListFragment extends Fragment {
    ...
    private static final String KEY_SUBTITLE_VISIBLE = "KEY_SUBTITLE_VISIBLE";
    ...
    private class TaskHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(Task task){
            ...
            else if(task.getCategory().equals(Category.Zakupy)){
        ...
        public CheckBox getCheckBox() {
            return itemView.findViewById(R.id.task_checkbox);
        }
    }
    ...
    private class TaskAdapter extends RecyclerView.Adapter<TaskHolder>{
        ...
        public void onBindViewHolder(@NonNull TaskHolder holder, int position){
            ...
            checkBox.setChecked(tasks.get(position).getDone());
            ...
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    if(checkBox.isChecked()) {
                        name.setPaintFlags(name.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
                        date.setPaintFlags(date.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
                        holder.task.setDone(checkBox.isChecked());
                    }
